...
async function submitForm(e) {
  ...
  try {
    const supportResp = await axios.post('/supports', supportData, config);
        ...
        <MainLayout title="Support Plearnd.com">
            ...
            <template #mainContent>
                <div class="plearnd-card">
                    ...
                    <div class="max-w-sm space-y-2 sm:flex sm:items-center sm:space-y-0 sm:space-x-2">
                        ...
                        <div class="grid grid-cols-1 gap-4 ">
                            <div class="-mx-3 flex flex-wrap">
                                <div class="w-full px-3 sm:w-1/2">
                                    <div class="">
                                        <VueDatePicker :id="'slip-date-input'" name="slipdateinput" v-model="transferDate" :format="'dd-MM-yyyy'" :enable-time-picker="false"></VueDatePicker>
                                    </div>
                                </div>
                                <div class="w-full px-3 sm:w-1/2">
                                    <div class="">
                                        <VueDatePicker id="slip-time-input" name="sliptimeinput" v-model="transferTime" format="HH:mm" :calendar-button="false" time-picker required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-2">
                            <div v-if="mediaImage">
                                <div class="relative mb-2 max-h-fit overflow-hidden">
                                    ...
                                    <button type="button" @click.prevent="deleteMediaImage"
                                    class="absolute top-1 left-1 rounded-full cursor-pointer bg-gray-100 p-2">
                                        <Icon icon="fa-solid:trash-alt" class="w-5 h-5 text-red-500" />
                                    </button>
                                </div>
