...
const studentPrefixName = (idx) => {
    ...
    if (!student.student_name_en) return ''

    if (student.prefix_name == 'เด็กหญิง' || student.prefix_name == 'นางสาว') {
        return 'Ms.'
    } else if (student.prefix_name == 'เด็กชาย' || student.prefix_name == 'นาย') {
        return 'Mr.'
    } else {
        return ''
    }
...
const studentThaiPrefixName = (index) => {
    ...
    if (!student?.student_name_th) return { prefix: '', txtSize: 'text-[46px]' };

    const fullLength = (student.student_name_th.length || 0) + (student.last_name_th?.length || 0);
    const isGirl = student.prefix_name === 'เด็กหญิง';
    const isBoy = student.prefix_name === 'เด็กชาย';
    const isMiss = student.prefix_name === 'นางสาว';

    if (fullLength < 15) {
        return { prefix: student.prefix_name, txtSize: 'text-[46px]' };
    }
    if (fullLength > 20) {
                ...
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full md:w-auto">
                        ...
                        <div class="flex items-center w-full sm:w-auto">
                            <button @click="$inertia.visit('/admin/student/card')"
                ...
                <div v-for="(student, index) in filteredStudents" :key="student.id">
                        ...
                        <div :ref="`card-${cardRef[index]}`" :id="`card-${index}`"
                            ...
                            <div class="flex p-[2%] gap-[2%] h-[80%]">
                                ...
                                <div class="w-[30%] h-[80%] rounded-xl overflow-hidden flex-shrink-0 mt-4">
                                    <!-- Photo Display -->
                                    <div v-if="student.student_image" class="w-full h-full relative ">
                                        <img :src="`/storage/images/students/${student.student_class}/${student.student_section}/${student.student_image}`"
                                ...
                                <div class="flex-1 relative">
                                    ...
                                    <div class="">
                                        <div class="flex items-center">
                                            ...
                                            <div :class="studentThaiPrefixName(index).txtSize" class="font-bold text-gray-800 leading-tight -mt-1">
                                                {{ studentThaiPrefixName(index).prefix }}{{ student.student_name_th }} {{ student.last_name_th }}
                                            </div>
                                        </div>
                                        <div class="flex items-center -mt-3">
                                            ...
                                            <div class="text-[36px] font-base text-gray-700 leading-tight ">
                                                <!-- if student.student_name_en is not empty display prefixname and student.student_name_en otherwise display empty string -->
                                                <span v-if="student.student_name_en">
                                                    {{ studentPrefixName(index) }}{{ student.student_name_en }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="flex">
                                            ...
                                            <div class="text-[42px] font-bold text-gray-700 leading-tight mr-3">:</div>
                                            <div class="text-[44px] font-bold text-gray-800 leading-tight ">
                                                {{ formattedIdNumber(student.id_card_no) }}
                                            </div>
                                        </div>
                                        <div class="flex -mt-4">
                                    ...
                                    <div class="">
                                        <div class="flex">
                                            ...
                                            <div class="text-[42px] font-bold text-gray-700 leading-tight mr-3">:</div>
                                            <div class="text-[44px] font-bold text-gray-800 leading-tight ">
                                                {{ student.student_class < 4 ? 'มัธยมศึกษาตอนต้น' : 'มัธยมศึกษาตอนปลาย' }} 
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex -mt-3">
                                            ...
                                            <div class="text-[42px] font-base text-gray-700 leading-tight text-transparent mr-4">:</div>
                                            <div class="text-[36px] font-base text-gray-700 leading-tight ">
                                                {{ student.student_class < 4 ? 'Lower Secondary' : 'Upper Secondary' }} 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="flex">
                                            ...
                                            <div class="text-[44px] font-bold text-gray-800 leading-tight ">
                                                {{ 
                                                    new Date(student.date_of_birth).toLocaleDateString('th-TH', {
                                                        day: '2-digit',
                                                        month: '2-digit',
                                                        year: 'numeric'
                                                    }) 
                                    ...
                                    <div class="-mt-1">
                                        <div class="flex">
                                            ...
                                            <div class="text-[44px] font-bold text-gray-800 leading-tight ">
                                                {{ 
                                                    new Date(student.expiry_date).toLocaleDateString('th-TH', {
                                                        day: '2-digit',
                                                        month: '2-digit',
                                                        year: 'numeric'
                                                    }) 
                            ...
                            <div class="absolute bottom-10 right-10 w-[192px]">
                                <QRCodeVue3 :value="`${student.student_id}`"
                    ...
                    <div class="flex justify-center items-center w-full mt-2">
                        <div class="w-full text-end">
                            <button @click="downloadCard(index, student.student_id)"
