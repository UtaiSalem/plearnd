...
const handleGetDonate = async (donateId, idx) => {
    try {
        ...
        if (getDonateResponse.data.success) {
            ...
            // usePage().$inertia.reload();
            if(usePage().props.auth.user) { usePage().props.auth.user.pp += 270 };

            // props.donates.data[idx].remaining_points -= 270;
                            ...
                            <div class="grid mx-auto">
                                ...
                                <!-- <div class="flex flex-col gap-2 pt-3">
                                    ...
                                    <button v-if="donate.status === 1 && $page.props.auth.user" 
                                        ...
                                        @click.prevent="handleGetDonate(donate.id, index)"
                                    >
                                        รับการสนับสนุน
                                    </button>
                                </div> -->
    ...
    <footer class="w-full px-4 mx-auto bg-gray-200 max-w-container sm:px-6 lg:px-8">
        <div class="py-10 text-center border-t border-slate-900/5">
            <!-- <div class="flex flex-wrap items-start justify-center">
                <span>www.</span>
                <span class="text-base text-gray-600 md:text-4xl">plearnd</span>
                <span>.com</span>
            </div> -->
