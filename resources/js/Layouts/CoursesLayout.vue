        ...
        <MainLayout :title="coursePageTitle" >
            <template #coverProfileCard>
                <div class="flex items-center max-w-7xl mx-auto jusb mt-2 mb-4 shadow-lg bg-[url('/storage/images/banner/banner-bg.png')] bg-cover bg-no-repeat">
                    ...
                    <p class="text-white font-bold text-4xl">รวมรายวิชา</p>
                </div>
                <div class=" bg-white shadow-xl w-full max-w-7xl mx-auto rounded-lg overflow-hidden mt-4">
                    <div class="flex flex-row justify-around">
                        <Link :href="`/courses`" v-if="$page.url===`/courses/feeds`" class="border-b-4 hover:border-cyan-500 rounded-none w-full text-center flex-row justify-center"
                        ...
                        <Link :href="`/courses/users/${$page.props.auth.user.id}`" 
                        ...
                        <Link :href="`/courses`" class="border-b-4 hover:border-gray-400 rounded-none w-full text-center flex-row justify-center "
                        ...
                        <Link :href="`/courses/create`" v-if="authUser.pp > 68400" class="border-b-4 hover:border-gray-400 rounded-none w-full text-center flex-row justify-center "
