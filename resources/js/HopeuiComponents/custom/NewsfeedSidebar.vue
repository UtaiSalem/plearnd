<template>
    <div>
        <aside x-data="sidebar" x-bind:class="[setting.sidebar_menu_style, setting.sidebar_color, setting.sidebar_type.join(' ')]" class="sidebar sidebar-base" data-toggle="main-sidebar">
        <div class="sidebar-header relative flex items-center justify-start mb-3 border-b dark:border-gray-700">
            <a href="../dashboard/index.html" class="flex px-5 py-4 mr-4 rtl:ml-4 rtl:mr-0 text-xl whitespace-nowrap">
                <!--Logo start-->
                    <svg width="30" class="text-primary-500  brand-logo w-[1.9rem]" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!--logo End-->
                <h4 class="sidebar-logo dark:text-white" data-setting="app_name" x-text="setting.app_name">Hope UI</h4>
            </a>
            <div class="sidebar-toggle" x-on:click="sidebarMini" data-toggle="sidebar" data-active="true">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" class="icon-20 rtl:rotate-180" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="sidebar-body data-scrollbar">
            <div class="sidebar-profile-card grid justify-center mt-3">
                <div class="sidebar-profile-body border-dashed border-2 border-primary-600 rounded-2xl p-5 px-10 mb-6">
                    <div class="sidebar-btn">
                        <span class="flex justify-center mb-4">
                            <svg class="icon-40 bg-primary-100 p-5 text-secondary-600 rounded-2xl w-20 dark:bg-dark-bg" viewBox="0 0 24 24" :class="'dark:text-primary'" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="sidebar-profile-detail flex flex-col justify-center">
                        <span class="item-name  text-black text-base dark:text-white mb-1">Add your Profile</span>
                        <small class="item-name  text-secondary-500 text-sm grid justify-center dark:text-primary-500">by @Musk</small>
                    </div>
                </div>
            ...
            <ul class="sidebar-main-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="../social-app/index.html">
                        <i class="icon">
                        ...
                        <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Social Dashboard" data-tw-placement="right"> D </i>
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../social-app/newsfeed.html">
                        <i class="icon">
                        ...
                        <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Newsfeed" data-tw-placement="right"> N </i>
                        <span class="item-name">Newsfeed</span>
                        <div>
                            <span class="ml-4 rtl:mr-4 rtl:ml-0  inline-block whitespace-nowrap px-2 py-1 text-xs text-center font-bold leading-none text-white bg-info-500 rounded-full">45</span>
                        </div>
                    </a>
                </li>
                <li class="nav-item" >
                    <a class="nav-link"  @click="toggle('social.friends')">
                        <i class="icon">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <i class="rtl:rotate-180 right-icon" x-bind:style="selected.includes('social.friends') ? 'transform:  rotate(90deg)' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </i>
                    </a>
                    <ul class="sub-menu" id="social.friends-menu" x-ref="social_friends" x-bind:style="selected.includes('social.friends') ? 'max-height: ' + $refs.social_friends.scrollHeight + 'px' : ''">
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/friend-list.html" data-sidebar-parent="social.friends">
                            <i class="icon">
                            ...
                            <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Friends List" data-tw-placement="right"> FL </i>
                            <span class="item-name">Friend List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/friend-request.html" data-sidebar-parent="social.friends">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Friend Request" data-tw-placement="right"> FR </i>
                                <span class="item-name">Friend Request</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/friend-profile.html" data-sidebar-parent="social.friends">
                            <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Friend Profile" data-tw-placement="right"> FP </i>
                ...
                <li class="nav-item" >
                    <a class="nav-link"  @click="toggle('social.profile')" >
                        <i class="icon">
                        ...
                        <i class="rtl:rotate-180 right-icon" x-bind:style="selected.includes('blog') ? 'transform:  rotate(90deg)' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </i>
                    </a>
                    <ul class="sub-menu" id="social.profile-menu" x-ref="social_profile" x-bind:style="selected.includes('social.profile') ? 'max-height: ' + $refs.social_profile.scrollHeight + 'px' : ''">
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/profile-badges.html" data-sidebar-parent="social.profile">
                            <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Profile Badges" data-tw-placement="right"> PB </i>
                            <span class="item-name">Profile Badges</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/profile-images.html" data-sidebar-parent="social.profile">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Profile Images" data-tw-placement="right"> PI </i>
                                <span class="item-name">Profile Images</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/profile-video.html" data-sidebar-parent="social.profile">
                            <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Profile Videos" data-tw-placement="right"> PV </i>
                            <span class="item-name"> Profile video</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/birthday.html" data-sidebar-parent="social.profile">
                            <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Birthday" data-tw-placement="right"> B </i>
                            <span class="item-name">Birthday</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/notification.html" data-sidebar-parent="social.profile">
                            <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Notification" data-tw-placement="right"> N </i>
                            <span class="item-name"> Notification</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/account-setting.html" data-sidebar-parent="social.profile">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Account Setting" data-tw-placement="right"> A </i>
                ...
                <li class="nav-item" >
                    <a class="nav-link"  @click="toggle('social.events')">
                        <i class="icon">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sub-menu" id="social.events-menu" x-ref="social_events" x-bind:style="selected.includes('social.events') ? 'max-height: ' + $refs.social_events.scrollHeight + 'px' : ''">
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/event-list.html" data-sidebar-parent="social.event">
                            <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Profile Event" data-tw-placement="right"> P </i>
                            <span class="item-name">Profile Event</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/event-detail.html" data-sidebar-parent="social.event">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Event Detail" data-tw-placement="right"> E </i>
                ...
                <li class="nav-item" >
                    <a class="nav-link"  @click="toggle('social.group')">
                        <i class="icon">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sub-menu" id="social.group-menu" x-ref="social_group" x-bind:style="selected.includes('social.group') ? 'max-height: ' + $refs.social_group.scrollHeight + 'px' : ''">
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/group-list.html" data-sidebar-parent="social.group">
                                <i class="icon">
                                        <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Group List" data-tw-placement="right"> G </i>
                                <span class="item-name">Group List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../social-app/group-detail.html" data-sidebar-parent="social.group">
                                <i class="icon">
                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Group Detail" data-tw-placement="right"> GD </i>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="../social-app/social-profile.html">
                        <i class="icon">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <i class="sidenav-mini-icon" data-tw-toggle="tooltip" title="Social Profile" data-tw-placement="right"> S </i>
