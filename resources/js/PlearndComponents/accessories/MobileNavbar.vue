...
<template>
    <div class="bg-[#34465d] p-1 mt-14 shadow-xl mx-auto w-full md:hidden">
        <div class="mx-auto flex w-full flex-row items-center justify-around h-11">
            <!-- <Link href="/">
                <SVGHome class="h-6 w-6 " />
            </Link>
            <Link href="#">
