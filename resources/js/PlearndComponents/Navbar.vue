                                ...
                                <div class="hidden md:ml-6 md:block">
                                    <div class="flex space-x-4">
                                        <a v-for="item in navigation" :key="item.name" :href="item.href"
                                            :class="[item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-violet-700 hover:text-white', 'rounded-md px-3 py-2 text-sm font-medium']"
                                            :aria-current="item.current ? 'page' : undefined">{{ item.name }}
                                        </a>
                                        <a :href="`/users/${$page.props.auth.user.id}/feed`" class="text-gray-300 hover:bg-violet-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">กระดานของฉัน</a>
                                    </div>
                                </div>
                            </div>
