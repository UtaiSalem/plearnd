...
<template>
    <!-- <li class="bg-white shadow-lg p-2 rounded-lg flex flex-wrap justify-between items-center w-full mb-3"> -->
        ...
        <div class="flex items-center min-w-fit">
            <img class="w-12 h-12 rounded-full" :src="props.courseMember.user.avatar" :alt="props.courseMember.user.name">
            <div class="ml-2">
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody>
                                <AuthMemberAttendanceDetail 
                                    ...
                                    :authMemberAttendanceStatus="attendance.details.filter((detail)=> detail.course_member.id === courseMember.user.id)"
                                />
                            </tbody>
                        </table>
                    </div>
