...
// const tempProps = defineProps({
//     group_index: Number
// });
// const props = reactive({
//     group: usePage().props.groups[tempProps.group_index],
//     group_index: tempProps.group_index,
//     courseMemberOfAuth: usePage().props.courseMemberOfAuth,
// });
...
const authIsGroupMember = computed(() => {
    // return props.group.groupMemberOfAuth.length > 0 ? props.group.authGroupMember[0].status:null;
    // return props.group.authGroupMember.length > 0 ? props.group.authGroupMember[0].status:null;
    return props.courseMemberOfAuth ? props.courseMemberOfAuth.group_id===props.group.id:false;
})
...
async function handleGroupMemberRequest(){
    ...
    try {   
        ...
        //     if (memberResp.data.newCourseMember.status == 1){
        //         usePage().props.course.data.isMember=true;
...
<template>
    <div
        ...
        <div v-if="!$page.props.isCourseAdmin" class="p-2 border-t mt-2">
            <div v-if="authIsGroupMember" class="group relative cursor-pointer w-56 mx-auto">
                <!-- <div> -->
                    ...
                    <div v-if="showGroupOptions"
                        class="absolute z-[80] flex w-full mx-auto flex-col py-1 text-gray-800 shadow-xl ">
            ...
            <!-- <button v-else-if="props.courseMemberOfAuth.status==='0'" disabled
                :class="{'bg-gray-600': isGroupMember}"
