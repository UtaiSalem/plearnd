        ...
        <div class="">
            ...
            <div v-else class="columns-2">
                <div v-for="(i) in 3" :key="i" class="">
                    <div class="relative mb-2 overflow-hidden max-h-fit">
                        <a href="">
                            <img :src="images[i].full_url" class="duration-300 rounded-lg hover:scale-110" />
                        </a>
                ...
                <div class="flex items-center justify-center"> 
                    <div class="relative overflow-hidden">
                        <img :src="images[4].full_url" alt="" class="duration-300 rounded-lg hover:scale-110 brightness-50">
