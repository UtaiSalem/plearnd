        ...
        <div class="">
            ...
            <div v-else class="columns-2">
                <div v-for="(i) in 3" :key="i" class="">
                    <div class="relative mb-2 max-h-fit overflow-hidden">
                        <a href="">
                            <img :src="'/storage/images/courses/lessons/'+images[i].image_url" class="rounded-lg hover:scale-110 duration-300" />
                        </a>
                ...
                <div class="flex justify-center items-center"> 
                    <div class="relative overflow-hidden">
                        <img :src="'/storage/images/courses/lessons/'+images[4].image_url" alt="" class="rounded-lg hover:scale-110 brightness-50 duration-300">
