...
<template>
    <th scope="row" :class="gradeStatus ? 'bg-green-50 text-green-500' : 'bg-red-50 text-red-500'"
    ...
    <td :class="gradeStatus ? 'bg-green-50 text-green-500' : 'bg-red-50 text-red-500'"
    ...
    <td :class="gradeStatus ? 'bg-green-50 text-green-500' : 'bg-red-50 text-red-500'"
    v-for="(quiz, qzIndx) in $page.props.quizzes.data" :key="quiz.id" class="px-2 py-1 border border-slate-300 text-center w-8">
