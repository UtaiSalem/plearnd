...
<template>
    <div class="w-full mt-4 overflow-hidden bg-white rounded-lg shadow-xl border border-gray-100">
        <!-- Scrollable container for mobile, flex distribute for desktop -->
        <div class="flex flex-row justify-start sm:justify-evenly overflow-x-auto sm:overflow-visible scrollbar-hide relative">
            <!-- Add horizontal scroll hint gradient on mobile -->
            ...
            <button type="button" @click.prevent="setActiveTab(12)"
                class="flex-shrink-0 min-w-[60px] sm:flex-shrink sm:flex-1 sm:min-w-0 text-center border-b-4 rounded-none tab-item hover:border-gray-400 transition-all duration-300 ease-in-out transform hover:scale-105"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 12 }">ข้อมูล</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(11)"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 11 }">กระดาน</span>
                </div>
            </button>
            ...
            <button v-if="props.isCourseAdmin || props.courseMemberOfAuth" type="button" @click.prevent="setActiveTab(7)"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 7 }">เข้าเรียน</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(1)"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 1 }">บทเรียน</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(2)"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 2 }">ภาระงาน</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(3)" v-if="props.courseMemberOfAuth || props.isCourseAdmin"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 3 }">ทดสอบ</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(5)"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 5 }">กลุ่ม</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(4)" v-if="props.courseMemberOfAuth !== null"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 4 }">สมาชิก</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(8)" v-if="props.isCourseAdmin"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 8 }">ตั้งค่า</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(9)" v-if="!props.isCourseAdmin && props.courseMemberOfAuth"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 9 }">ผลการเรียน</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(10)" v-if="props.isCourseAdmin"
                ...
                <div class="flex flex-col items-center justify-center py-2 sm:py-3 text-slate-600/80 transition-all duration-300">
                    ...
                    <span class="text-[10px] sm:text-xs md:text-sm mt-0.5 sm:mt-1 font-medium transition-all duration-300 whitespace-nowrap" :class="{ 'text-cyan-500 font-semibold': activeTab === 10 }">ผลการเรียน</span>
                </div>
            </button>
