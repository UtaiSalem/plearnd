    ...
    <div class="w-full mt-4 overflow-hidden bg-white rounded-lg shadow-xl ">
        <div class="flex flex-row justify-around">
            ...
            <button type="button" @click.prevent="setActiveTab(12)"
                ...
                :class="{ 'border-b-4 border-cyan-500 bg-cyan-100': activeTab === 12 }">
                <div class="flex flex-col items-center justify-center py-2 text-slate-600/80 ">
                    <Icon icon="heroicons:information-circle" class="w-6 h-6 md:w-8 md:h-8"
                        :class="{ 'text-cyan-500': activeTab === 12 }" />
                    <span class="hidden md:block" :class="{ 'text-cyan-500': activeTab === 12 }">ข้อมูลทั้วไป</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(2)"
                ...
                <div class="flex flex-col items-center justify-center py-2 text-slate-600/80 ">
                    ...
                    <span class="hidden md:block" :class="{ 'text-cyan-500': activeTab === 2 }">ภาระงาน</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(3)" v-if="props.courseMemberOfAuth || props.isCourseAdmin"
                ...
                <div class="flex flex-col items-center justify-center py-2 text-slate-600/80 ">
                    ...
                    <span class="hidden md:block" :class="{ 'text-cyan-500': activeTab === 3 }">ทดสอบ</span>
                </div>
            </button>
            ...
            <button type="button" @click.prevent="setActiveTab(8)" v-if="props.isCourseAdmin"
                ...
                <div class="flex flex-col items-center justify-center py-2 text-slate-600/80 ">
                    ...
                    <span class="hidden md:block" :class="{ 'text-cyan-500': activeTab === 8 }">ตั้งค่า</span>
                </div>
            </button>
