    ...
    <div class="m-4">
        <form :id="`asm-answer-form-${assignment_id+$page.props.auth.user.id}`" class="mt-3 relative dark:border-secondary-800 flex items-start">
            ...
            <button @click.prevent="onSubmitAsmAns"
                ...
                class="mx-2 w-10 p-[6px]  rounded-lg border  "
