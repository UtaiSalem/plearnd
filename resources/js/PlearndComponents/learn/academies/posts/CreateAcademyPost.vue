...
const privacyOptions = reactive([
    ...
    const postForm = reactive({
        content: '',
        'academy_id': props.academy_id, // 'academy_id': 'required|integer',
        point:1,
        privacy_settings: 3,
        images: [],
    });
    ...
    async function onSubmitCreatePost(){
        ...
        try {
            ...
            formData.append('academy_id', postForm.academy_id);
            ...
            const response = await axios.post(`/api/academies/${props.academy_id}/posts`, formData, config);
