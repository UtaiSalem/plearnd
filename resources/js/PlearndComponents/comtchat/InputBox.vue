<template>
    ...
    >
        ...
        <div class="flex justify-evenly p-3 border-t">
            ...
            <div
                class="flex flex-col filter hover:brightness-110 transition duration-150 transform hover:scale-105 cursor-pointer"
                v-if="imageToPost"
                @click="removeImage"
            >
...
import { EmojiHappyIcon } from "@heroicons/vue/24/outline";
