<template>
    <div class="sticky z-58 bg-white flex items-center p-2 lg:px-5 shadow-md">
        ...
        <div class="flex items-center">
            <img
                :src="'../../storage/images/badge/bronze-b.png'"
                alt="Facebook Logo"
                width="40"
                height="40"
                loading="lazy"
            ...
            <div class="flex ml-2 items-center rounded-full bg-gray-100 p-2">
                ...
                <input
                    class="hidden md:inline-flex ml-2 items-center bg-transparent outline-none flex-shrink"
                    type="text"
        ...
        <div class="flex justify-center flex-grow">
            <div class="flex space-x-6 md:space-x-2">
                <div
                    class="flex items-center cursor-pointer md:px-10 sm:h-14 md:hover:bg-gray-100 rounded-xl group"
                    @click="moveTo('/')"
                >
                    <HomeIcon
