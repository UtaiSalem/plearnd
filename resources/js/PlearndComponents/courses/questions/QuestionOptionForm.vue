        ...
        <form :id="`comment-form-${question_id}`" class="mt-2 relative dark:border-secondary-800 flex items-start">
            <div class="relative w-full">
                ...
                <!-- <small class="absolute flex justify-between w-full px-2 py-1 text-xs transition text-slate-400 peer-invalid:text-pink-500">
                    <span></span>
                    <span class="text-slate-500"> {{ newQstOptionForm.text.length }} </span>
                </small> -->
