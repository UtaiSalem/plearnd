...
<template>
    <div class="w-full">            
        ...
        <div class="bg-white border-t-4 border-blue-600 rounded-lg overflow-hidden shadow-lg my-4 px-2">
            ...
            <div v-for="(question,idx) in props.questions" :key="question.id" class="border rounded-md p-1 my-2">
                <QuestionItem 
                    :question="question" 
                    :indexNumber="idx" 
