            ...
            <div class="" v-if="$page.props.isCourseAdmin">
                <form class="space-y-2" v-if="questionInputActive">
                    ...
                    <div class="relative mt-4">
                        <textarea id="id-01" type="text" name="id-01" v-model="questionInput.text" placeholder="Write your message" rows="3" class="relative w-full px-4 py-2 text-sm placeholder-transparent transition-all border rounded outline-none focus-visible:outline-none peer border-slate-200 text-gray-800 autofill:bg-white invalid:border-pink-500 invalid:text-pink-500 focus:border-emerald-500 focus:outline-none invalid:focus:border-pink-500 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400"></textarea>
