<script setup>
    ...
    import IndividualPostImagesViewer from './../play/posts/PostViewerPartials/IndividualPostImageViewer.vue';
    ...
    async function onSubmitUpdatePost(){
        ...
        if(postResponse.data.success){
            ...
            // props.activity.target_resource.images = response.data.post.images;
                    ...
                    <form @submit.prevent="onSubmitUpdatePost" id="UpdatePostForm">
                        ...
                        <div class="mt-4 mx-1 flex items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <button type="button" @click.prevent="handleCancleEditPost" class="px-2 py-1 rounded-lg bg-gray-100 border border-red-500 text-sm text-red-500 dark:text-white hover:scale-110">ยกเลิก</button>
                                <button type="submit" :disabled="waiting || !canBePosted" class="px-2 py-1 rounded-lg bg-blue-100 border border-blue-500 text-sm text-blue-500 dark:text-white disabled:cursor-not-allowed" :class="canBePosted ? 'hover:scale-110' : 'cursor-not-allowed'">บันทึก</button>
                            </div>
                        </div>
                    </form>
                </div>
