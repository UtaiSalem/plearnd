    ...
    <div class="max-w-sm mx-auto space-y-2 sm:py-2 sm:flex sm:items-center sm:space-y-0 sm:space-x-2">
        ...
        <div class="text-center space-y-2 sm:text-left">
            ...
            <button @click.prevent="handleDeleteFriendRequest" v-if="refPerson.is_friend"
                class="px-4 py-1 text-sm text-purple-600 font-normal rounded-full border border-purple-200 hover:text-white bg-purple-200 hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2">
                <div class="flex items-center justify-center">
                    <Icon v-if="isLoading" icon="bi:arrow-repeat" class="inline-block w-4 h-4 mr-2 animate-spin" />
