...
const handleLikesComment = async () => {
    ...
    // await axios.post(`/post_image_comments/${props.comment.id}/like`); 
    ...
    // let likeResp = await axios.post(`/post_image_comments/${props.comment.id}/like`);
    try {
        isLoading.value = true;
        let likeResp = await axios.post(`/post_image_comments/${props.comment.id}/like`);
...
const handleDislikesComment = async () => {
    try {
        isLoading.value = true;
        let dislikeResp = await axios.post(`/post_image_comments/${props.comment.id}/dislike`);
