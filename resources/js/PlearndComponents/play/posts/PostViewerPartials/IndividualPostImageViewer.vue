...
import PostImageReactionViewer from '@/PlearndComponents/play/posts/PostViewerPartials/PostImages/PostImageReactionViewer.vue';
        ...
        <div class="columns-1">
            <div v-for="(image, index) in images_resources" :key="image.image_url" class="">
                <div class="relative mb-2 max-h-fit overflow-hidden border">
                    ...
                    <PostImageReactionViewer :post :image :model="'post'" />
                </div>
            </div>
        </div>
    </div>
