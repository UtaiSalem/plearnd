...
use App\Http\Controllers\OptimizedNewsfeedController;

Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    // Optimized newsfeed routes
    Route::get('/optimized-newsfeed', [OptimizedNewsfeedController::class, 'index'])->name('optimized.newsfeed');
    Route::get('/api/newsfeed/activities', [OptimizedNewsfeedController::class, 'getPaginatedActivities'])->name('api.newsfeed.activities.paginated');
    Route::post('/api/newsfeed/clear-cache', [OptimizedNewsfeedController::class, 'clearNewsfeedCache'])->name('api.newsfeed.clear-cache');
    
    // API endpoints for lazy loading post data
