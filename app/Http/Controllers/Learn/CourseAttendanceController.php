...
class CourseAttendanceController extends Controller
{
    ...
    public function index(Course $course)
    {
        ...
        return Inertia::render('Learn/Course/Attendance/Attendances', [
            ...
            'attendances'   => CourseAttendanceResource::collection($course->courseAttendances->where('group_id', $courseMemberOfAuth->group_id)),
            // 'attendances'   => $course->courseAttendances->where('group_id', $courseMemberOfAuth->group_id),
        ]);
    }
