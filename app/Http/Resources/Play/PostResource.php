...
class PostResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'imagesResources'   => \App\Http\Resources\Play\PostImageResource::collection($this->postImages),
            ...
            'post_comments'     => \App\Http\Resources\Play\PostCommentResource::collection($this->getComments()),
            'shares'            => $this->shares,
            'views'             => $this->views,
