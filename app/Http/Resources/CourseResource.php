...
class CourseResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'assignments' => $this->whenLoaded('courseAssignments', fn() => AssignmentResource::collection($this->courseAssignments), []),
            'quizzes' => $this->whenLoaded('courseQuizzes', fn() => $this->courseQuizzes, []),
            'groups' => $this->whenLoaded('courseGroups', fn() => $this->courseGroups, []),
